...
namespace scripts.Network
{
    ...
    {
        public const string HOST = "http://192.168.102.13:8001";

		//GET

		public const string URL_GET_INFO_USER = HOST + "/api/v2/game/getInfoUser";
		public const string URL_GET_ALL_CHARACTER = HOST + "/api/v2/game/getAllCharacterUser";
		public const string URL_GET_ALL_ITEM_CHARACTER = HOST + "/api/v2/game/getAllItemsCharacter";

		//POST
		public const string URL_POST_EQUIP_CHARACTER = HOST + "/api/v2/game/equipCharacter";
